...
namespace Spotify
{
    public static class LinkExtensions
    {
        ...
        {
            return CreateLink(image, Spotify.Core.Native.Spotify.sp_link_create_from_image);
        }

        public static ILink<IArtist> ToLink(this IArtist artist)
        {
            return CreateLink(artist, Spotify.Core.Native.Spotify.sp_link_create_from_artist);
        }
        ...
        public static ILink<ITrackAndOffset> ToLink(this ITrack track)
        {
            return CreateLink<ITrackAndOffset>(
                ...
                track.Session,
                h => Spotify.Core.Native.Spotify.sp_link_create_from_track(h, 0));
        }
        ...
        public static ILink<ITrackAndOffset> ToLink(this ITrack track, TimeSpan offset)
        {
            return CreateLink<ITrackAndOffset>(
                ...
                track.Session,
                h => Spotify.Core.Native.Spotify.sp_link_create_from_track(h, (int)offset.TotalMilliseconds));
        }

        public static ILink<IAlbum> ToLink(this IAlbum album)
        {
            return CreateLink(album, Spotify.Core.Native.Spotify.sp_link_create_from_album);
        }
        ...
        public static ILink<IImage> AlbumCoverToLink(this IAlbum album, ImageSize imageSize = ImageSize.Normal)
        {
            return CreateLink<IImage>(
                ...
                album.Session,
                handle => Spotify.Core.Native.Spotify.sp_link_create_from_album_cover(handle, imageSize));
        }
        ...
        public static ILink<IImage> ArtistPortraitToLink(this IArtistBrowse artistBrowse, int artistIndex)
        {
            return CreateLink<IImage>(
                ...
                h => Spotify.Core.Native.Spotify.sp_link_create_from_artistbrowse_portrait(h, artistIndex));
        }

        public static ILink<IPlaylist> ToLink(this IPlaylist playlist)
        {
            return CreateLink(playlist, Spotify.Core.Native.Spotify.sp_link_create_from_playlist);
        }

        public static ILink<IUser> ToLink(this IUser user)
        {
            return CreateLink(user, Spotify.Core.Native.Spotify.sp_link_create_from_user);
        }
        ...
        public static ILink<ISearch> ToLink(this ISearch search)
        {
            ...
            lock (Spotify.Core.Native.Spotify.Mutex)
            {
                linkPtr = Spotify.Core.Native.Spotify.sp_link_create_from_search(wrapper.Handle);
            }
        ...
        public static ILink FromLink(this ISession session, string link)
        {
            ...
            lock (Spotify.Core.Native.Spotify.Mutex)
            {
                linkHandle = Spotify.Core.Native.Spotify.sp_link_create_from_string(link);
            }
