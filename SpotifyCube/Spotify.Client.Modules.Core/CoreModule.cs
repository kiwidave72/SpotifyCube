...
using Spotify.Client.Modules.Core.Views;
using Spotify.Client.Modules.Core.Views.Album;
using Spotify.Client.Modules.Core.Views.Artist;
using Spotify.Client.Modules.Core.Views.Navigation;
using Spotify.Client.Modules.Core.Views.Notifications;
using Spotify.Client.Modules.Core.Views.NowPlaying;
using Spotify.Client.Modules.Core.Views.Player;
using Spotify.Client.Modules.Core.Views.Playlist;
using Spotify.Client.Modules.Core.Views.PlayQueue;
using Spotify.Client.Modules.Core.Views.Search;
using Spotify.Client.Modules.Core.Views.Starred;
using Spotify.Client.Modules.Core.Views.WhatsNew;
